...
Initially thoiugh, the interface will give volunteer working on the project with a tool to use to easly check and test database fundtionality, queries and connections.
